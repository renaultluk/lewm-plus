...
srun --container-image "$CONTAINER_PATH" \
     ...
     --export="STABLEWM_HOME=${STABLEWM_HOME},WANDB_DISABLED=${WANDB_DISABLED:-false},PATH=/workspace/.venv/bin:/root/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin,VIRTUAL_ENV=/workspace/.venv" \
